...
### ➭ Social Media Clone 
A full-stack social media web application inspired by Facebook and Twitter, featuring posts, likes, comments, and followings.

- ➤ Built with Node.js, Express, MongoDB, Prisima
- ➤ Secure JWT-based authentication
- ➤ Clean, responsive UI with scalable backend architecture  
👉 [View Project](https://github.com/prernababali/social-media-clone)

---

### ➭ Secure File Uploader
A secure file upload application that allows authenticated users to upload, manage, and access files through protected routes.
...
### ➭ Taskify Mobile to do Application 
A cross-platform mobile To-Do application focused on productivity, task prioritization, and secure data handling.
...
# 📊 GitHub Stats:
![](https://github-readme-stats.vercel.app/api?username=prernababali&theme=vision-friendly-dark&hide_border=true&include_all_commits=true&count_private=true)<br/>
...
---
[![](https://visitcount.itsvg.in/api?id=prernababali&icon=0&color=0)](https://visitcount.itsvg.in)
